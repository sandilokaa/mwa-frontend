    ...
    return (
        <div>
            <div className="flex gap-2">   
                ...
                <p className="font-bold">Project Target Detail</p>
            </div>
            <div className="grid grid-cols-4 mt-5 gap-5">
                <div className="bg-white w-full rounded-[10px] p-5 col-span-3">
                    <div className="flex justify-between">
                        <p className="text-sm font-bold">Project Target Information</p>
                        <Link className="cursor-pointer" href="/project-target/:id/edit">
