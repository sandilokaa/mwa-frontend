    ...
    return (
        <div>
            <div className="flex gap-2">   
                ...
                <p className="font-bold">Add Quality Target</p>
            </div>
            <div className="mt-5 bg-white w-full rounded-[10px] p-5">
                <p className="text-sm font-bold">Quality Target Form</p>
                <div className="flex flex-col gap-y-5 mt-5">
                    <div className="flex flex-col gap-y-4">
                        <div className="grid grid-cols-3 gap-4">
                            <div className="col-span-2">
                                <InputForm
                                    label="Quality Target Name *"
                                    placeholder="Example: 6x6 Conversion Design"
                                    ref={nameRef}
                                    defaultValue="Quality Target"
                                    disable
                                />
                            </div>
                            <DropdownProductForm
