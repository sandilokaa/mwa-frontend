    ...
    return (
        <div>
            <div className="flex gap-2">   
                ...
                <p className="font-bold">Add General Dimension</p>
            </div>
            <div className="mt-5 bg-white w-full rounded-[10px] p-5">
                <p className="text-sm font-bold">General Dimension Form</p>
                <div className="flex flex-col gap-y-5 mt-5">
                    <div className="flex flex-col gap-y-4">
                        <div className="grid grid-cols-3 gap-4">
                            <div className="col-span-2">
                                <InputForm
                                    label="General Dimension Name *"
                                    placeholder="Example: 6x6 Conversion Design"
                                    ref={nameRef}
                                    defaultValue="General Dimension"
                                    disable
                                />
                            </div>
                            <DropdownProductForm
                    ...
                    <div className="flex justify-end">
                        <SubmitButton
                            ...
                            buttonText="Add General Dimension"
                        />
                    </div>
                </div>
            </div>
